...
# NOTE !!!!
***Almost 90% this project are generated by Microsoft Copilot, what i do are just type the prompt related project or describing feature that i want it to add. Fork and edit by yourself if you want to give an improvements, and also don't pull request***.  *Thank You*
...
> Replace `227` with the correct line number for your chosen GPIO pin. You can find this using `gpiodetect` and `gpioinfo`.
...
/usr/lib/lua/luci/view/fan/logview.htm      # Last 10 Log View 
/usr/lib/lua/luci/view/fan/statusinfo.htm   # Info Status Fan
