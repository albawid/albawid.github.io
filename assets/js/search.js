! function() {
  ...
  ! function(t) {
      let i = {
              ...
              searchResultTemplate: '<li class="box-shadow"><a href="{url}" class="pre-box"><div class="box"><h2 class="judul-post-blog">{title}</h2><h4><i class="fa fa-calendar"></i> {date}</h4><p class="preview">{excerpt}</p><span class="tag">{tags}</span></div></a></li>',
